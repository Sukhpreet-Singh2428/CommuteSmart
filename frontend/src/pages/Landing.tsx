        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="glass-card p-8 rounded-2xl hover:bg-white/5 transition-colors cursor-default group">
              ...
              <div className="glass-card p-8 rounded-2xl hover:bg-white/5 transition-colors cursor-default group sm:translate-y-8">
      ...
      <section className="py-20 border-t border-white/5" id="cities">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            <div className="text-2xl font-serif font-bold text-white">CHANDIGARH METRO</div>
            <div className="text-2xl font-sans font-black text-white tracking-tighter">RAJPURA LINK</div>
            <div className="text-2xl font-mono font-bold text-white">PATIALA SPEED</div>
            <div className="text-2xl font-sans font-bold italic text-white">AMBALA TRANSIT</div>
          </div>
        </div>
      </section>
